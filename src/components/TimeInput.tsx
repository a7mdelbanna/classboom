  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      <button
        ...
        className="px-3 py-1.5 border border-gray-300 rounded-lg hover:border-orange-500 transition-colors bg-white flex items-center space-x-1"
      >
      ...
      {isOpen && (
        <motion.div
          ...
          className="absolute z-50 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-3 flex space-x-2"
        >
          <div>
            ...
            <div className="h-32 overflow-y-auto border border-gray-200 rounded">
              {generateHours().map((h) => (
                <button
                  ...
                  className={`block w-full px-3 py-1 text-sm hover:bg-orange-50 ${
                    hours === h ? 'bg-orange-100 font-medium' : ''
                  }`}
                >
                  {h}
                </button>
            ...
            <div className="h-32 overflow-y-auto border border-gray-200 rounded">
              {generateMinutes().map((m) => (
                <button
                  ...
                  className={`block w-full px-3 py-1 text-sm hover:bg-orange-50 ${
                    minutes === m ? 'bg-orange-100 font-medium' : ''
                  }`}
                >
                  {m}
                </button>
